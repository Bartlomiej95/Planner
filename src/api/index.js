...
export const editRate = (id, value, type) => axios.put(urlHomepageUser, { id, value, type });
...
export const updateTask = (id, isFinish, time, addedTime) => axios.put(urlHomepageUser, {id, isFinish, time, addedTime}); 
