...
import { editRate } from '../../store/Rates/actions';
...
const RightBox = styled.div<{ readonly isEdited: boolean}>`
    display: block;
...
const RateRow = ({ position, rate, id }:Rates) => {
    ...
    const handleChange = (e : { target: HTMLInputElement}) => {
        ...
        setValueEditedRate(Number(e.target.value));
    }
